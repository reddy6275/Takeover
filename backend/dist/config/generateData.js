...
const generateDocuments = (industry) => {
    const list = [];
    const titles = {
...
// 3. Tickets Generator
const generateTickets = (industry) => {
    const list = [];
...
const generateConversations = (industry) => {
    const list = [];
...
const generateAnalytics = (industry) => {
    const baseCharts = {
        chatsTrend: [
            { date: 'Mon', count: 18 },
            { date: 'Tue', count: 24 },
...
// 9. Policies Suite
const generatePolicies = (industry) => {
    return {
...
// 10. Prompts
const generatePrompts = (industry) => {
    const suggested = {
        legal: [
