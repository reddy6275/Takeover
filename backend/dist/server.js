    ...
    try {
            ...
            if (!existingDoc) {
                ...
                if (insErr) {
                    ...
                    for (let i = 0; i < matchingChunks.length; i++) {
                        ...
                        if (chunkErr)
                            console.error(`Failed to seed chunk for doc ${doc.filename}:`, chunkErr.message);
                    }
                }
            }
        }
            ...
            if (!existingConv) {
                ...
                if (insErr) {
                    ...
                    for (const msg of matchingMsgs) {
                        ...
                        if (msgErr)
                            console.error(`Failed to seed message ${msg.id}:`, msgErr.message);
                    }
                }
            }
        }
        ...
        for (const ticket of mockDb.tickets) {
            ...
            if (!existingTicket) {
                ...
                if (insErr)
                    console.error(`Failed to seed ticket ${ticket.title}:`, insErr.message);
            }
        }
